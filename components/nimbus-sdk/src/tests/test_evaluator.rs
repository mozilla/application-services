...
fn test_locale_substring() -> Result<()> {
    ...
    let es: SDKEventStore = Box::new(EventStore::new());
    let event_store = Arc::new(Mutex::new(es));
    assert_eq!(
...
use crate::behavior::SDKEventStore;
...
fn test_event_sum_transform() {
    ...
    let es: SDKEventStore = Box::new(EventStore::from(vec![(
...
fn test_event_transform_sum_cnz_avg_avgnz_parameters() {
    ...
    assert_eq!(
        ...
        Some(EnrollmentStatus::Error {
            reason: "EvaluationError: Custom error: nimbus-core error: Transform parameter error: event transform Sum requires 2-3 parameters"
                .to_string()
        })
    );
    assert_eq!(
        ...
        Some(EnrollmentStatus::Error {
            reason: "EvaluationError: Custom error: nimbus-core error: JSON Error: invalid type: floating point `1`, expected a string"
                .to_string()
        })
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        Some(EnrollmentStatus::Error {
            reason: "EvaluationError: Custom error: nimbus-core error: Behavior error: IntervalParseError: Day is not a valid Interval"
                .to_string()
        })
    );
    assert_eq!(
        ...
        Some(EnrollmentStatus::Error {
            reason: "EvaluationError: Custom error: nimbus-core error: Transform parameter error: event transform Sum requires a positive number as the second parameter"
                .to_string()
        })
    );
    assert_eq!(
        ...
        Some(EnrollmentStatus::Error {
            reason: "EvaluationError: Custom error: nimbus-core error: Transform parameter error: event transform Sum requires a positive number as the third parameter"
                .to_string()
        })
    );
}
...
fn test_event_transform_last_seen_parameters() {
    ...
    assert_eq!(
        ...
        Some(EnrollmentStatus::Error {
            reason: "EvaluationError: Custom error: nimbus-core error: Transform parameter error: event transform LastSeen requires 1-2 parameters"
                .to_string()
        })
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        Some(EnrollmentStatus::Error {
            reason: "EvaluationError: Custom error: nimbus-core error: Transform parameter error: event transform LastSeen requires a positive number as the second parameter"
                .to_string()
        })
    );
}
