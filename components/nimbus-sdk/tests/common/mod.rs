...
use nimbus_sdk::{error::Result, AppContext, NimbusClient, RemoteSettingsConfig};
...
) -> Result<NimbusClient, nimbus_sdk::NimbusError> {
...
use nimbus_sdk::persistence::{Database, SingleStore};
