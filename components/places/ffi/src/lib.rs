...
// XXX - places_connection_destroy should probably be replaced (or maybe just
// augmented) with a function that takes an API handle, calls
// PlacesApi::close_connection and then drops it from the handlemap?
