...
lipo -create -output "$SRCROOT"/../../../target/universal/release/libplaces_ffi.a \
"$SRCROOT"/../../../target/x86_64-apple-ios/release/libplaces_ffi.a \
"$SRCROOT"/../../../target/aarch64-apple-ios/release/libplaces_ffi.a \
