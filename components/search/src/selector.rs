...
mod tests {
    ...
    fn mock_changes_endpoint() -> mockito::Mock {
        ...
        .with_body(test_helpers::response_body_changes())
        .with_status(200)
    ...
    fn test_remote_settings_search_config_records_is_none_throws_error() {
        ...
        .with_body(test_helpers::response_body())
        .with_status(501)
        .with_header("content-type", "application/json")
        .with_header("etag", "\"1000\"")
        .create();
    ...
    fn test_remote_settings_search_config_overrides_records_is_none_throws_error() {
        ...
        .with_body(test_helpers::response_body_overrides())
        .with_status(501)
        .with_header("content-type", "application/json")
        .with_header("etag", "\"1000\"")
        .create();
    ...
    fn test_filter_with_remote_settings_negotiate_locales() {
        ...
        .with_body(test_helpers::response_body_locales())
        .with_status(200)
        .with_header("content-type", "application/json")
        .with_header("etag", "\"1000\"")
        .create();
