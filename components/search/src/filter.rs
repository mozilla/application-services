...
mod from_configuration_details_tests {
    use crate::test_helpers::{
        ExpectedEngineFromBase, ENGINE_BASE, ENGINE_SUBVARIANT, ENGINE_VARIANT,
    };
    use crate::*;
    use once_cell::sync::Lazy;
    use pretty_assertions::assert_eq;
    ...
    fn test_uses_base_values_only() {
        ...
        assert_eq!(result, ExpectedEngineFromBase::new("test", "Test").build());
    }
    ...
    fn test_uses_locale_specific_visual_display_name() {
        ...
        assert_eq!(
            result,
            ExpectedEngineFromBase::new("test", "Test")
