...
#[cfg(test)]
pub fn response_body_changes() -> String {
    json!({
      "timestamp": 1000,
      "changes": [
        {
...
#[cfg(test)]
pub fn response_body_locales() -> String {
    json!({
      "metadata": {
        "id": "search-config-v2",
        "last_modified": 1000,
...
#[cfg(test)]
pub fn response_body_overrides() -> String {
    json!({
      "metadata": {
...
#[cfg(test)]
pub static ENGINE_VARIANT: Lazy<JSONEngineVariant> = Lazy::new(|| JSONEngineVariant {
...
#[cfg(test)]
pub static ENGINE_SUBVARIANT: Lazy<JSONEngineVariant> = Lazy::new(|| JSONEngineVariant {
    environment: JSONVariantEnvironment {
        all_regions_and_locales: true,
        ..Default::default()
    },
