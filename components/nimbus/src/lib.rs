...
pub struct InternalMutableState {
    pub available_randomization_units: AvailableRandomizationUnits,
    // Application level targeting attributes
    pub targeting_attributes: TargetingAttributes,
}
...
pub struct NimbusClient {
    ...
    pub mutable_state: Mutex<InternalMutableState>,
...
impl Branch {
    pub fn get_feature_configs(&self) -> Vec<FeatureConfig> {
...
pub struct AvailableRandomizationUnits {
    ...
    #[allow(dead_code)]
    pub dummy: i8, // See comments in nimbus.udl for why this hacky item exists.
}
