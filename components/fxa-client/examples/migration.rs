...
//static REDIRECT_URI: &'static str = "https://latest.dev.lcip.org/oauth/success/3c49430b43dfba77";
static REDIRECT_URI: &'static str = "http://127.0.0.1:3030/oauth/success/3c49430b43dfba77";
...
fn main() {
    ...
    fxa.migrate_from_session_token(&session_token, &k_sync, &k_xcs).unwrap();
