...
// TODO: Move the above to somewhere else - everything below is our "public" error list.
// Probably copy the pattern started by fxa-client - everything above moves to `internal/`?
