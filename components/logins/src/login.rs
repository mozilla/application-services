...
impl Login {
    pub fn new(meta: LoginMeta, fields: LoginFields, sec_fields: SecureLoginFields) -> Self {
        Self {
            ...
            time_last_potentially_valnerable_password_set: fields.time_last_breach_alert_dismissed,
    ...
    pub(crate) fn from_row(row: &Row<'_>) -> Result<EncryptedLogin> {
        let login = EncryptedLogin {
            ...
            fields: LoginFields {
                ...
                time_last_potentially_valnerable_password_set: row
                    .get::<_, Option<i64>>("timeLastPotentiallyVulnerablePasswordSet")?,
