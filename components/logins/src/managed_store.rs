...
fn get_key() -> String {
    ...
    // let token = serde_json::to_string(&jwcrypto::Jwk::new_direct_from_bytes(None, &key)).unwrap();
    // println!("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
    // println!("Using logins key: {:?}", token);
    // println!("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
    // token
...
mod test {
    ...
    #[test]
    fn test_general() {
        let store = ManagedLoginStore::new_in_memory().unwrap();
