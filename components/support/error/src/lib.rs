...
#[cfg(all(feature = "log-logging", not(feature = "tracing-logging")))]
...
// work-arounds for --no-default-features
#[cfg(not(any(feature = "log-logging", feature = "tracing-logging")))]
pub use log::{debug, error, info, trace, warn, Level};
...
#[cfg(not(any(feature = "log-logging", feature = "tracing-logging")))]
pub fn init_for_tests_with_level(_: Level) {}
