...
public enum FxAccountManagerError: LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case let .unauthorized(message):
            return "FxAccountManagerError.unauthorized: \(message)"
        case let .network(message):
            return "FxAccountManagerError.network: \(message)"
        case let .unspecified(message):
            return "FxAccountManagerError.unspecified: \(message)"
        case let .panic(message):
            return "FxAccountManagerError.panic: \(message)"
        }
    }
