...
mod tests {
    ...
    fn test_credit_card_create_and_read() -> Result<()> {
        ...
        let retrieved_credit_card = get_credit_card(&mut db, saved_credit_card.guid.to_string())?;
        ...
        let delete_result = delete_credit_card(&mut db, saved_credit_card.guid.to_string());
        assert!(delete_result.is_ok());
        assert!(delete_result?);

        assert!(get_credit_card(&mut db, saved_credit_card.guid.to_string()).is_err());
    ...
    fn test_credit_card_read_all() -> Result<()> {
        ...
        let delete_result = delete_credit_card(&mut db, saved_credit_card3.guid.to_string());
        assert!(delete_result.is_ok());
        assert!(delete_result?);
    ...
    fn test_credit_card_update() -> Result<()> {
        ...
        let update_result = update_credit_card(
            &mut db,
            &CreditCard {
                guid: saved_credit_card.guid.clone().to_string(),
        ...
        let updated_credit_card = get_credit_card(&mut db, saved_credit_card.guid.to_string())?;
    ...
    fn test_credit_card_delete() -> Result<()> {
        ...
        let delete_result2 = delete_credit_card(&mut db, saved_credit_card2.guid.to_string());
