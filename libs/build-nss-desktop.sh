...
if [[ "${CROSS_COMPILE_TARGET}" =~ "darwin" ]]; then
  if [[ "${MOZ_AUTOMATION}" == "1" ]]; then
    ...
    curl -sfSL --retry 5 --retry-delay 10 -O "https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/emvF9PZPSAKlA6yAYJi-TQ/runs/0/artifacts/public%2Fdist.tar.bz2"
    SHA256="bfa6da3583422100f7924d508d6b4c7ffac6a709628ee98a24e82163569ef4a7"
