...
enum Experiments {
    public static var shared: NimbusApi = {
        ...
        // we can retrieve experiments from. In this case we are using the
        // staging endpoint for the purpose of this sample application.
        var nimbusEndpointUrl: URL {
            var components = URLComponents()
            components.scheme = "https"
            components.host = "settings.stage.mozaws.net"
