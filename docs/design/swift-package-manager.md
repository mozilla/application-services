...
- firefox-ios uses a local swift package and consumes the xcframework https://github.com/mozilla-mobile/firefox-ios/blob/main/MozillaRustComponents/Package.swift
...
Firefox iOS consumes the XCFramework via the local package: [MozillaRustComponents/Package.swift](https://github.com/mozilla-mobile/firefox-ios/blob/main/MozillaRustComponents/Package.swift).
...
- Add the package product(s) to the app targets that need them.
