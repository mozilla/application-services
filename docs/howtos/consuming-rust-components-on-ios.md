...
- If you are using the megazord version of the Rust component, `MozillaAppServices.framework`, it is being built as a static lib; therefore, do _not_ follow the standard Carthage procedure of adding it to your `carthage copy-frameworks` script.
